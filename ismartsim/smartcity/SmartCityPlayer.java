 ...
 */
public class SmartCityPlayer implements Observer {
	...
	public SmartCityPlayer() {
		FogSimulation.getInstance().addObserver(SmartCityPlayer.this);
	}
	...
	public static void main(String[] args) {
		...
		SmartCityPlayer smartCityGeoSimulation = new SmartCityPlayer();
		...
		frame.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent ke) {
				...
				if (ke.getKeyCode() == KeyEvent.VK_J) {
					loadSensorGeoPositionsFromFile(cloudGeo, userClientGeo);
				}
	...
	protected void loadSensorGeoPositionsFromFile(final GeoPosition cloudGeo, final GeoPosition userClientGeo) {
		sensorsGeoPositions.clear();
		wifiSpotsGeoPositions.clear();
		
		//TODO get options from GUI file selector
		sensorsGeoPositions.addAll(SimulationUtil.importPositionsFromGeoJson("speed_camera_poa.geojson"));
//			sensorsGeoPositions.addAll(SimulationUtil.importPositionsFromGeoJson("traffic_signals_poa.geojson"));
		...
		System.out.println("loadSensorGeoPositionsFromFile");
	...
	public void updateMapOverlay() {
		updateMapOverlay(SmartCityPlayer.cloudGeoPosition, SmartCityPlayer.userGeoPosition);
	}
	...
	public void update(Observable o, Object arg) {
		try {
			...
			String pathResultFile = "./results/"+id+".csv";			
			...
			for (SimulationEvent simulationEvent : allLogEvents) {
			...
			String pathEventsJsonFile = "./results/Events-"+id+"--"+hashcode+".json";			
